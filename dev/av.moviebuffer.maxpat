...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 218.0, 165.0, 55.0, 22.0 ],
					"text" : "route file"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 165.0, 135.0, 72.0, 22.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 330.0, 42.0, 197.0, 33.0 ],
					"text" : "av.moviebuffer"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 45.0, 240.0, 111.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 45.0, 210.0, 78.0, 22.0 ],
					"text" : "t l unloadram"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "bang" ],
					"patching_rect" : [ 45.0, 165.0, 127.0, 22.0 ],
					"text" : "opendialog .mov .mp4"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(message) done when file read completed",
					"id" : "obj-6",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 523.0, 420.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					"comment" : "(read) read a movie file",
					"id" : "obj-3",
					"index" : 1,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
,
					"patching_rect" : [ 480.0, 375.0, 62.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 135.0, 330.0, 446.0, 22.0 ],
					"text" : "jit.movie @output_texture 1 @vol 0 @autostart 0 @engine viddll @cache_size 0.5"
				}
