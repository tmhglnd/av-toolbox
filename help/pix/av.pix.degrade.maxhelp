                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 180.5, 278.0, 68.0, 20.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 119.5, 278.0, 49.0, 20.0 ],
                                    "text": "amount"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "preset_data": [
                                        {
                                            "number": 1,
                                            "data": [ 5, "obj-6", "number", "int", 4, 5, "obj-7", "number", "float", 0.20000000298023224 ]
                                        },
                                        {
                                            "number": 2,
                                            "data": [ 5, "obj-6", "number", "int", 3, 5, "obj-7", "number", "float", 0.10000000149011612 ]
                                        }
                                    ]
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 30.0, 68.0, 240.0, 20.0 ],
                                    "saved_attribute_attributes": {
                                        "textcolor": {
                                            "expression": "themecolor.theme_textcolor"
                                        }
                                    },
                                    "text": "A pixelate and color downsample algorithm."
                                }
                            },
                            {
                                "box": {
