                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 201.5, 120.0, 95.0, 47.0 ],
                                    "text": "input texture dim determines noise resolution"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 113.5, 120.0, 88.0, 22.0 ],
                                    "text": "dim 1920 1080"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int", "", "" ],
                                    "parameter_enable": 1,
                                    "patching_rect": [ 199.0, 390.0, 100.0, 22.0 ],
                                    "saved_attribute_attributes": {
                                        "valueof": {
                                            "parameter_enum": [ "linear", "none" ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numoutlets": 1,
                                    "outlettype": [ "" ],
                                    "patching_rect": [ 199.0, 420.0, 48.0, 22.0 ],
                                    "text": "filter $1"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "preset_data": [
                                        {
                                            "number": 1,
                                            "data": [ 5, "obj-9", "toggle", "int", 0, 5, "obj-7", "number", "int", 30 ]
                                        },
                                        {
                                            "number": 2,
                                            "data": [ 5, "obj-9", "toggle", "int", 1, 5, "obj-7", "number", "int", 200 ]
                                        }
                                    ]
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 30.0, 390.0, 139.0, 22.0 ],
                                    "text": "av.pix.noise @filter none"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "text": "jit.gl.texture @dim 160 90"
                                }
                            },
                            {
                                "box": {
