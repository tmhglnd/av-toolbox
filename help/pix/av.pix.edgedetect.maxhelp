                        ...
                        "boxes": [
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 245.0, 278.0, 38.0, 20.0 ],
                                    "text": "invert"
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "outlettype": [ "int" ],
                                    "parameter_enable": 0,
                                    "patching_rect": [ 252.0, 299.0, 24.0, 24.0 ]
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 180.5, 278.0, 55.0, 20.0 ],
                                    "text": "linewidth"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 116.0, 278.0, 58.0, 20.0 ],
                                    "text": "threshold"
                                }
                            },
                            {
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "preset_data": [
                                        {
                                            "number": 1,
                                            "data": [ 5, "obj-9", "toggle", "int", 0, 5, "obj-6", "number", "float", 2.0, 5, "obj-7", "number", "float", 0.1679999977350235 ]
                                        },
                                        {
                                            "number": 2,
                                            "data": [ 5, "obj-9", "toggle", "int", 1, 5, "obj-6", "number", "float", 14.0, 5, "obj-7", "number", "float", 0.5299999713897705 ]
                                        }
                                    ]
                                }
                            },
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "patching_rect": [ 30.0, 375.0, 102.0, 22.0 ],
                            ...
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 30.0, 68.0, 381.0, 20.0 ],
                                    "saved_attribute_attributes": {
                                        "textcolor": {
                                            "expression": "themecolor.theme_textcolor"
                                        }
                                    },
                                    "text": "Perform edge detection on an image and output as black-white image."
                                }
                            },
                            {
                                "box": {
                                    ...
                                    "numinlets": 1,
                                    "numoutlets": 0,
                                    "patching_rect": [ 30.0, 15.0, 319.0, 51.0 ],
                                    "saved_attribute_attributes": {
                                        "textcolor": {
                                            "expression": "themecolor.theme_textcolor"
                                        }
