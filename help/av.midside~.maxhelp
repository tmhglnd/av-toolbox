...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 68.0, 300.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 102.5, 285.0, 74.0 ],
									"text" : "output the mid (sum/mono R+L) and side (subtract, L-R and R-L) information from a stereo signal.\n\nUseful for later analysis of for example various frequency bins or with an envelope follower",
