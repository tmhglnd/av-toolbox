...
,
					"patching_rect" : [ 105.0, 135.0, 27.0, 22.0 ],
...
,
									"text" : "You can use mulitple textures with jit.gl.multiple to apply to planes (or any other gridshape). The patch below gives an example of how this can work with the th.gl.texturefolder"
								}
...
,
										...
										"boxes" : [ 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 45.0, 90.0, 37.0, 22.0 ],
													"text" : "zl.len"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 61.0, 185.0, 51.0, 22.0 ],
													"text" : "zl.group"
												}
...
, 											{
												"box" : 												{
													...
													"patching_rect" : [ 45.0, 140.0, 51.0, 22.0 ],
													"text" : "uzi 10 0"
												}
...
, 											{
												"box" : 												{
													...
													"numoutlets" : 2,
													"outlettype" : [ "", "" ],
													"patching_rect" : [ 61.0, 215.0, 51.0, 22.0 ],
													"text" : "jit.fill tex"
												}
...
,
					"patching_rect" : [ 60.0, 90.0, 73.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
									...
									"textovercolor" : [ 0.129412, 0.129412, 0.129412, 1.0 ],
									"usebgoncolor" : 1,
									"usetextovercolor" : 1
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 315.0, 270.0, 80.0, 35.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 177.0, 594.0, 52.0, 22.0 ],
									"text" : "480 640"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 178.0, 564.0, 59.0, 22.0 ],
									"text" : "route dim"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 143.0, 443.0, 51.0, 22.0 ],
									"text" : "r texfold"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 394.0, 613.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "7",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 349.0, 600.0, 54.0, 22.0 ],
									"text" : "s names"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 409.0, 600.0, 123.0, 33.0 ],
									"text" : "see tab \"multiple\" for example with names"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 365.0, 570.0, 71.0, 22.0 ],
									"text" : "print names"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 349.0, 540.0, 75.0, 22.0 ],
									"text" : "route names"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 48.0, 410.0, 29.5, 22.0 ],
									"text" : "add"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 260.0, 390.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "4",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 57.0, 300.0, 76.0, 47.0 ],
									"text" : "manually change the output"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 68.0, 419.0, 87.0 ],
									"saved_attribute_attributes" : 									{
										"textcolor" : 										{
											"expression" : "themecolor.theme_textcolor"
										}
...
,
									"text" : "Load a folder with image-files into individual textures (loaded in a javascript array). Easily access the texture with the outputtexture message, or use the texture name that you provide with the ascending numbering. Add a single texturefile with the add message. Use the dim and count output to control aspectratio scaling and other things in your patch. Use this object if you want to use many images in a patch."
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 215.0, 300.0, 32.0, 22.0 ],
									"text" : "gate"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 306.0, 346.0, 116.0, 20.0 ],
									"text" : "use the total count"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 215.0, 375.0, 39.0, 22.0 ],
									"text" : "urn-jb"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 235.0, 345.0, 69.0, 22.0 ],
									"text" : "route count"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 228.0, 270.0, 80.0, 22.0 ],
									"text" : "speedlim 250"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 205.0, 496.0, 209.0, 20.0 ],
									"text" : "arguments: context texture-name"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 275.0, 405.0, 120.0, 33.0 ],
									"text" : "output the selected texture from index"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 215.0, 405.0, 50.0, 22.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 215.0, 443.0, 95.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 30.0, 564.0, 98.0, 22.0 ],
									"text" : "jit.gl.layer texfold"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "jit_matrix", "bang", "" ],
									"patching_rect" : [ 30.0, 225.0, 474.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 82.0, 375.0, 113.0, 74.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 30.0, 375.0, 33.0, 22.0 ],
									"text" : "read"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 30.0, 495.0, 167.0, 22.0 ],
									"text" : "av.texturefolder texfold myTex"
								}
...
, 							{
								"patchline" : 								{
									"destination" : [ "obj-12", 0 ],
									"midpoints" : [ 187.5, 527.0, 429.0, 527.0, 429.0, 334.0, 244.5, 334.0 ],
									"order" : 1,
									"source" : [ "obj-1", 1 ]
								}
...
,
					"patching_rect" : [ 30.0, 45.0, 47.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
		"dependency_cache" : [ 			{
				"name" : "av.texturefolder.maxpat",
				"bootpath" : "~/Sync/work/code/max/packages/av-toolbox/patchers",
				"patcherrelativepath" : "../patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
				"name" : "texturefolder.js",
				"bootpath" : "~/Sync/work/code/max/library/abstractions/th.gl.texturefolder/code",
				"patcherrelativepath" : "../../../library/abstractions/th.gl.texturefolder/code",
				"type" : "TEXT",
				"implicit" : 1
			}
, 			{
