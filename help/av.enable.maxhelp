...
,
									"patching_rect" : [ 224.5, 240.0, 77.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 312.5, 171.0, 20.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 135.0, 411.0, 135.0, 33.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 90.0, 285.0, 209.0, 20.0 ],
									"text" : "disable the processing with the toggle"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 105.0, 411.0, 24.0, 24.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 32.5, 420.0, 24.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 32.5, 450.0, 60.0, 22.0 ],
									"text" : "av.enable"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 73.5, 480.0, 162.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 32.5, 285.0, 24.0, 24.0 ],
									"saved_attribute_attributes" : 									{
										"valueof" : 										{
											"parameter_enum" : [ "off", "on" ],
											"parameter_initial" : [ 1.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "" ],
									"patching_rect" : [ 73.5, 375.0, 237.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 73.5, 210.0, 170.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_gl_texture", "jit_gl_texture" ],
									"patching_rect" : [ 32.5, 315.0, 60.0, 22.0 ],
									"text" : "av.enable"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 52.5, 428.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "3",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 52.5, 293.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "2",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 73.5, 180.0, 24.0, 24.0 ],
									"varname" : "toggle[2]"
								}
...
, 							{
								"box" : 								{
									...
									"patching_rect" : [ 32.5, 535.0, 59.0, 22.0 ],
									"text" : "jit.gl.layer"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "jit_matrix", "" ],
									"patching_rect" : [ 330.0, 180.0, 360.0, 225.0 ],
									"sync" : 1
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 52.5, 167.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
									"textcolor" : [ 0.34902, 0.34902, 0.34902, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 90.0, 348.0, 47.0 ],
									"text" : "Enable/disable the processing of a jit.gl.pix or jit.gl.slab object. Either process by outputtting through right outlet or bypass it by using the left outlet. A toggle enables or disables it.",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 135.0, 334.5, 150.0, 22.0 ]
								}
...
,
		...
		"lines" : [  ],
		"parameters" : 		{
			"obj-2::obj-10" : [ "toggle", "toggle", 0 ],
			"obj-2::obj-16" : [ "toggle[1]", "toggle[1]", 0 ],
			"parameterbanks" : 			{
				"0" : 				{
					"index" : 0,
					"name" : "",
