...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 56.0, 287.0, 224.0, 20.0 ],
									"text" : "outputs true when the mouse is hidden"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 142.0, 240.0, 238.0, 33.0 ],
									"text" : "Arguments:\nidle time in milliseconds (default = 5000)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "int" ],
									"patching_rect" : [ 30.0, 240.0, 110.0, 22.0 ],
									"text" : "av.hidecursor 5000"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 165.0, 233.0, 20.0 ],
									"text" : "enable the hidecursor (enabled by default)"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "", "int" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 47.5, 202.0, 20.0, 20.0 ],
									"rounded" : 60.0,
									"text" : "1",
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "int" ],
									"parameter_enable" : 1,
									"patching_rect" : [ 30.0, 187.0, 24.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 30.0, 93.0, 390.0, 47.0 ],
									"text" : "Hide the cursor automatically when the mouse is idle for a specified amount of time. Useful to make sure you can't accidentally leave your mouse on the jitter window during a performance and have it be visible.",
