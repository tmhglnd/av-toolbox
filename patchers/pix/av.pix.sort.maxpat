        ...
        "boxes": [
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 397.5, 403.0, 19.0, 22.0 ],
                    "text": "t l"
                }
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 421.5, 365.0, 108.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 397.5, 336.0, 115.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 1,
                    "outlettype": [ "" ],
                    "patching_rect": [ 397.5, 300.0, 79.0, 22.0 ],
                    "text": "prepend filter"
                }
            },
            {
            ...
            },
            {
                "box": {
                    ...
                    "patching_rect": [ 75.0, 433.0, 91.0, 22.0 ],
            ...
            },
            {
                "box": {
                    ...
                    "numoutlets": 2,
                    "outlettype": [ "", "" ],
                    "patching_rect": [ 236.5, 53.0, 180.0, 22.0 ],
                    "text": "patcherargs 0.5 0.5 @filter none"
                }
            },
            {
                "box": {
        ...
        "lines": [
            ...
            },
            {
                "patchline": {
                    ...
                    "midpoints": [ 287.0, 317.0, 335.12109375, 317.0, 335.12109375, 109.0, 246.0, 109.0 ],
                    "source": [ "obj-26", 3 ]
                }
            },
            {
