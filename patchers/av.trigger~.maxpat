...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 105.0, 210.0, 51.0, 22.0 ],
					"text" : "unjoin 3"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 225.0, 135.0, 55.0, 22.0 ],
					"text" : "zl.slice 2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 102.5, 135.0, 100.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 75.0, 256.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 465.0, 40.0, 149.0, 33.0 ],
					"text" : "av.trigger~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 50.0, 340.0, 42.0, 22.0 ],
					"text" : "edge~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 127.0, 300.0, 89.0, 22.0 ],
					"text" : "thresh~ 0.2 0.4"
				}
...
, 			{
				"box" : 				{
					"comment" : "(signal/float) high threshold",
					"id" : "obj-342",
					"index" : 3,
					"maxclass" : "inlet",
					"numinlets" : 0,
...
, 			{
				"box" : 				{
					"comment" : "(bang) trigger when signal crosses threshold",
					"id" : "obj-343",
					"index" : 1,
					"maxclass" : "outlet",
					"numinlets" : 1,
...
, 			{
				"box" : 				{
					"comment" : "(signal) amplitude gate",
					"id" : "obj-344",
					"index" : 2,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 127.0, 375.0, 30.0, 30.0 ]
				}
